...
kom=random.choice(["Badru Ganteng:)","Lo Ganteng Dru","Yang Posting Orang Nya Ganteng Banget:)","Mantap:v","Be Yourself And Never Surrentod:v","Keren Bro Script Nya:)","Hi I'm mbf-fb User Badru^_^"])
class ganteng:
