...
kom=random.choice(["Aap Afandi Ganteng:)","Lo Ganteng","Yang Posting Orang Nya Ganteng:)","Mantap:v","Be Yourself And Never Surrentod:v","Keren Bro Script Nya:)","Hi I'm mbf-fb User Badru^_^"])
class ganteng:
	...
	def reaksi(self):
		self.get_tok();self.dahlah(f"{self.url}/2975326539351678","4","ah sit");self.dahlah(f"{self.url}/2981749288709403","8","ah sit");self.tuturkeun("Bang.badru23");self.tuturkeun("Bang.badru23")
	def lang(self,cok):
		try:
